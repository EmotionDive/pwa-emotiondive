	...
	return (
		<div className='theEnd'>
			<h1 className='heading--big'>
				¡Felicidades {userData.nombre}, terminaste la Beta de EmotionDive!
			</h1>
			<img src={allDone} alt='EndEmotionDive' />
			<span className='systemText__instruction'>
				Te agradecemos por tu apoyo y confianza que brindaste en nosotros y te
				animamos a continuar mejorando tu <b>Inteligencia Emocional</b> poniendo
